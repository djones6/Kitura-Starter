...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/IBM-Swift/Swift-JWT.git", .upToNextMajor(from: "1.0.0"))
    ],
    targets: [
      .target(
        name: "Kitura-Starter",
        dependencies: ["Kitura", "HeliumLogger", "Controller", "SwiftJWT"]
      ),
      .target(
        name: "Controller",
        dependencies: ["Kitura", "CloudEnvironment", "Health", "SwiftJWT"]
      ),
      .testTarget(
